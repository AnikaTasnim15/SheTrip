...
class SOSAlertAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        """Auto-notify when admin updates status"""
        super().save_model(request, obj, form, change)

        if obj.status == 'responding' and change:
            # Notify user that help is on the way
            subject = 'SheTrip: Help is On The Way!'
            message = f"""
Dear {obj.user.first_name},

We've received your emergency alert and help is on the way!

Our team has been notified and is coordinating assistance.
Your emergency contacts have also been alerted.
